...
wget -O texts.zip http://translator.simutrans.com/translator/data/tab/language_pack-$PAK.zip
unzip texts.zip
...
wget -O texts.zip http://translator.simutrans.com/translator/data/tab/language_pack-Scenario+Tutorial+$PAK.zip
unzip texts.zip
rm texts.zip
